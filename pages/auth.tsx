    ...
    <div className="relative h-full w-full bg-[url('https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/f562aaf4-5dbb-4603-a32b-6ef6c2230136/dh0w8qv-9d8ee6b2-b41a-4681-ab9b-8a227560dc75.jpg/v1/fill/w_1192,h_670,q_70,strp/the_netflix_login_background__canada__2024___by_logofeveryt_dh0w8qv-pre.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..LOYKSxIDqfPwWHR0SSJ-ugGQ6bECF0yO6Cmc0F26CQs')] bg-no-repeat bg-fixed bg-cover ">
        <div className="bg-black h-full w-full lg:bg-opacity-50">
            ...
            <div className="flex justify-center">
                ...
                <button className="bg-red-600 py-3 text-white rounded-md mt-10 w-full hover:bg-red-700 transation">
                    {variant === 'login' ? 'login': 'Sign up'}
                </button>
                <p className="text-neutral-500 mt-12  ">New to Netflix?
                <span onClick={toggleVariant} className="text-white ml-1 hover:underline crusor-pointer">Sign up now</span>
                </p>
